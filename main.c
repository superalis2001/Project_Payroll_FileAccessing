...
int main()
{
    ...
    switch (choice)
    {
        ...
        case '1': // Option 1 - starts the process.
        system ("COLOR 0B");
        system ("cls");
        workingDays();
        generalPayroll();
        ...
        case '2': // Option 2 - opens the function for displaying records.
        system ("cls");
        system ("COLOR 0B");
        displayRecords();
        printf("\n");
        ...
        case '3': // Option 3 - opens the function for deleting your records.
        system ("COLOR 0B");
        system ("cls");
        eraseRecords();
        system ("cls");
        ...
        case '4': // Option 4- shows the creator's info
        system ("cls");
        system ("COLOR 0B");
        aboutCreator();
        printf("\n");
        ...
        case '5': // Option 5 - exits the program
        exit (0);
        break;

        default: // For handling inputs outside the choices
        system ("cls");
        system ("COLOR 0B");
...
// Function for getting the input for your desired month and its maximum days.
int getMonth()
{
...
// Function for getting the input for the days worked by an employee
void workingDays()
{
...
// Function for calculating the payroll of all your employees.
void generalPayroll()
{
...
// Function for displaying your different records.
void displayRecords()
{
...
// Function for erasing your records.
void eraseRecords()
{
...
// Function for opening the text file for opening the info of the creator,
void aboutCreator()
{
